const InputForm = {
      ...
      <form @submit="submitForm" class="ui form">
        ...
        <div class="field">
          <div class="ui checkbox">
            ...
            <span style="color: red">{{ fieldErrors.termsAddConditions }}</span>
          </div>
        </div>
        <button 
  ...
  data() {
    return {
      ...
      fieldErrors: {
        ...
        email: undefined,
        urgency: undefined,
        termsAddConditions: undefined,
      },
      items: [],
      loading: false,
      saveStatus: 'READY',
      //possibilites for saveStatus:
  ...
  methods: {
    submitForm(evt) {
      ...
      this.fields.email = '';
      this.fields.urgency = '';
      this.fields.termsAddConditions = false;
    },
    validateForm(fields) {
      const errors = {};
      ...
      if (!fields.termsAddConditions)
        errors.termsAddConditions = 'Terms and conditions have to be approved';
